...
authorAddBtn.addEventListener("click", function (evt) {
  ...
  xhttp.open("POST", "http://18.217.63.113:5000/admin/authors");
...
editAuthorBtn.addEventListener("click",(evt)=>{
  ...
  xhttp.open("POST", `http://18.217.63.113:5000/admin/authors/${id}/edit`);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send(JSON.stringify({
    "picture":localStorage.getItem("current_image_name"),
...
function listAuthors() {
  ...
  xhttp.open("GET", "http://18.217.63.113:5000/admin/authors");
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send()
};
