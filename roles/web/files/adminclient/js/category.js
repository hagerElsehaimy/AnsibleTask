...
categoryAddBtn.addEventListener("click", function (evt) {
  ...
  xhttp.open("POST", "http://18.217.63.113:5000/admin/categories");
...
function editCategories(uri) {
  ...
  xhttp.open("POST", `http://18.217.63.113:5000/admin/categories/${uri}/update`);
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send(JSON.stringify({
...
function listCategories() {
  ...
  xhttp.open("GET", "http://18.217.63.113:5000/admin/categories");
  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  xhttp.send()
};
